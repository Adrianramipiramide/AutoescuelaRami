...
CREATE TABLE `Test_Preguntas` (
  ...
  KEY `idTest` (`idTest`),
  CONSTRAINT `Test_Preguntas_ibfk_1` FOREIGN KEY (`idPregunta`) REFERENCES `Preguntas` (`id`),
  CONSTRAINT `Test_Preguntas_ibfk_2` FOREIGN KEY (`idTest`) REFERENCES `Test` (`id`)
...
-- Dump completed on 2025-05-13 11:11:35
